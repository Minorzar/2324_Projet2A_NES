...
vcom -93 -work work {D:/Git/Projet/2324_Projet2A_NES/software/VHDL/CPU/Quartus_CPU/../testbench/CPU_address_bus_register_tb.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L cyclonev_hssi -L rtl_work -L work -voptargs="+acc"  address_bus_register
